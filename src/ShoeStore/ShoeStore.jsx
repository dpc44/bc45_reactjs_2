...
export default class ShoeStore extends Component {
    ...
    renderProductList() {
        console.log("this.childRef.current: ", this.childRef);
        return this.state. dataProduct.map((item) => {
            return <div className='col-4' key={item.id}>
                <Product ref={this.childRef} item={item} />
                {/* <Modal dataProduct = {this.state.dataProduct}/>    */}
                <Modal item = {item}/>  
            </div>
        })
